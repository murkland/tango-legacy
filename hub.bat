...
bbn6.exe -connect_addr=http://167.71.122.211:11223 -session_id=%SESSION_ID% 2> bbn6.log
pause
GOTO EOF
echo:
:CLIENT
...
set /p "SESSION_ID=matchmaking code (no spaces, pick one you and your friend agree on!): "
bbn6.exe -connect_addr=http://167.71.122.211:11223 -answer -session_id=%SESSION_ID% 2> bbn6.log
pause
GOTO EOF
echo:
